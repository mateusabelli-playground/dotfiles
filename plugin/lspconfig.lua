...
local lsp_defaults = {
  -- Amount of miliseconds to wait to send the next document update notification.
  lsp_flags = {
    -- This is the default in Nvim 0.7+
    debounce_text_changes = 150,
  },

  -- Send updated features from nvim-cmp to neovim
...
-- (Already set on /after/plugin/mason.lua)
-- lsp_installer.setup {}
